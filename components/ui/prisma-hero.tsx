...
const PrismaHero = () => {
  return (
    <section className="h-[100svh] w-full p-2 md:p-3">
        ...
        <div className="absolute bottom-0 left-0 right-0 px-4 pb-2 sm:px-6 md:px-10">
          <div className="grid grid-cols-12 items-end gap-4">
            ...
            <div className="col-span-12 lg:col-span-8">
              <h1
                className="font-medium leading-[0.85] tracking-[-0.07em] text-[19vw] sm:text-[18vw] md:text-[17vw] lg:text-[13.5vw]"
                style={{ color: "#E1E0CC" }}
              >
                <WordsPullUp text="Shobhita" showAsterisk />
              </h1>
            </div>
            ...
            <div className="col-span-12 flex flex-col gap-5 pb-6 lg:col-span-4 lg:pb-10">
              ...
              >
                Dr. Shobhita Gupta — computational biophysicist working at the
                intersection of AI and drug discovery, decoding the brain and
                neurodegenerative disorders. PhD in Biophysics, Cornell University.
              </motion.p>
